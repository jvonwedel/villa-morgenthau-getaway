      ...
      <div className="container-custom relative h-full flex flex-col justify-center">
        <div className="max-w-3xl">
          <div className="inline-flex items-center bg-white/90 px-4 py-2 rounded-sm mb-6">
            ...
            <span className="text-sm font-medium">Tranquility & Relaxation</span>
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif text-white mb-6">
            Finding Your Inner Peace
          </h1>
          <p className="text-lg md:text-xl text-white/90 max-w-2xl">
            Villa Morgenthau offers the perfect setting for those seeking calm, relaxation, and a connection with nature.
          </p>
        </div>
      </div>
    </section>
